...
function builder(options) {
  ...
  if (!options.network) {
    options.network = stashcore.Networks.defaultNetwork;
  }

  options.Block = options.Block || stashcore.Block;
  options.BlockHeader = options.BlockHeader || stashcore.BlockHeader;
  options.Transaction = options.Transaction || stashcore.Transaction;
  options.MerkleBlock = options.MerkleBlock || stashcore.MerkleBlock;
  options.MnListDiff = options.MnListDiff || stashcore.MnListDiff;
